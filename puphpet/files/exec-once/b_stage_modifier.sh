#!/usr/bin/env bash
#this script is responsible for managing if the a_install_ohs_wp_foundation_I.sh and a_install_ohs_wp_foundation_II.sh
# is used for a brand new WP site or for setting up an existing site.case
